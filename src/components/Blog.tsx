      ...
      <div className="container mx-auto px-4">
        ...
        >
          {[...blogPosts, ...blogPosts].map((post, index) => (
            <Card key={index} className="group flex-shrink-0 w-[280px] sm:w-[350px] snap-start overflow-hidden hover:shadow-card-shadow transition-all duration-300 hover:-translate-y-2 bg-card/50 backdrop-blur-sm border-border/50">
